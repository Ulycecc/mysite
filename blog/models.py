...
class Post(models.Model):
    ...
    class Status(models.TextChoices):
        ...
        DRAFT и PUBLISHED.
        Их соответствующими значениями выступают DF и PB,
    ...
    # в пакете django.contrib.auth и содержит модель User
    ...
    # параметр choices ограничиваtn значение поля вариантами из Status.choices
